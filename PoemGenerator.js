    ...
    if (session.attributes) {
        ...
        http.get(url(poemTopic), function(res){
         ...
         buildSpeechletResponse(cardTitle, speechOutput, repromptText, shouldEndSession));
            ...
            //var heading = 'Generated ' + intent.slots.Topic.value + ' poem is:';
            //response.tellWithCard(text, heading, cardText);
        //speechOutput = poem;
        //repromptText = "You can ask me to generate a poem by saying, generate a love poem.";
    } else {
